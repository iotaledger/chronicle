defmodule Broker.Collector.TxValidator do
  ...
  def handle_events(events, _from, state) do
    ...
    # ask tx_distributor for more events at max_demand.
    GenStage.ask(:tx_distributor, @max_demand)
  ...
  defp process_events([{hash, <<c0::81-bytes,c1::81-bytes,
      ...
      c28::81-bytes,c29::81-bytes,c30::81-bytes,c31::81-bytes,c32::81-bytes>>}
