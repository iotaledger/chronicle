...
enum retcode_t {
  ...
  RC_FAILED_THREAD_SPAWN = 0x04 | RC_MODULE_GENERAL | RC_SEVERITY_FATAL,
  RC_FAILED_THREAD_JOIN = 0x05 | RC_MODULE_GENERAL | RC_SEVERITY_MODERATE,
  RC_STILL_RUNNING = 0x06 | RC_MODULE_GENERAL | RC_SEVERITY_MODERATE,
